...
The examples below use Rust syntax because that was the first SDK with broad
coverage, but the same property shapes carry over directly to PHP/Pest. For the
PHP surface, load `references/php.md`.
